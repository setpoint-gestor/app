        ...
        if (isGestorLogado) {
            ...
            elNome.innerHTML = `
                <div class="header-user-wrapper">
                    ...
                    <div class="header-user-badges" id="container-badges-gestor">
                        <span class="badge" style="background-color: ${corBadge}; margin-left: 6px; font-size: 10px; padding: 2px 6px;">${txtBadge}</span>
                    </div>
                </div>
            `;
            ...
            database.ref(`Clubes/${clubeAtivoId}/info_clube/ativo`).once('value').then((snapAtivo) => {
                if (snapAtivo.val() === false) {
                    ...
                    if (elBadges) {
                        elBadges.innerHTML += `<span class="badge" style="background-color: #ef4444; margin-left: 4px; font-size: 10px; padding: 2px 6px; border: 1px solid #7f1d1d;">OFF</span>`;
                    }
                }
            });
        } else {
